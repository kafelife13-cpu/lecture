...
const CACHE_NAME = 'kukeo-wang-v153-login-wait';
const URLS_TO_CACHE = [
  '/lecture/literature.js?v=4',
  '/lecture/literature-study.js?v=1',
  '/lecture/literature.css?v=2',
  '/lecture/clinic-check.js?v=2',
  '/lecture/clinic-check.css?v=2',
  '/lecture/index.html',
  '/lecture/app-navigation.js?v=1',
  '/lecture/video-chapters.js?v=1',
  '/lecture/classical-vocab.js?v=2',
  '/lecture/student-sections.js?v=20260922-review',
  '/lecture/personal-review.js?v=1',
  '/lecture/student-ui.css?v=3',
  '/lecture/weekly-homework.js?v=5',
  '/lecture/weekly-homework.css?v=2',
